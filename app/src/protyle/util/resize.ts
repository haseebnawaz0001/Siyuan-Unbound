...
export const resize = (protyle: IProtyle) => {
    ...
    const MIN_ABS = 4;
    // Must not clearTimeout, otherwise the left side can't resize when splitting
    setTimeout(() => {
        ...
        // A value below MIN_ABS also causes wrapping https://github.com/siyuan-note/siyuan/issues/13677
    ...
    }, Constants.TIMEOUT_TRANSITION + 100);   // Wait for the setPadding animation to finish
};
