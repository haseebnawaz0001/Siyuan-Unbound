...
func (repo *Repo) sync0(context map[string]interface{},
	...
	// Documents resolved by a block-level merge. They are written over the checked-out cloud copy below so that the
	// merge index picks the combined content up and uploads it.
	var mergedTrees []*mergedTree
